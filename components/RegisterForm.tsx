    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <form onSubmit={handleSubmit} className="max-w-md w-full mx-auto p-8 bg-white rounded-2xl shadow-lg border border-blue-100">
        ...
        <input
          ...
          aria-label="Password"
        />
        <button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-green-400 hover:from-blue-600 hover:to-green-500 text-white font-semibold p-3 rounded-lg shadow transition">Register</button>
